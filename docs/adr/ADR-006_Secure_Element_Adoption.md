...
| 작성일 | 2026-06-02 |
| 관련 요구사항 | FR-CAN-010, SR-ATK-005, SR-ATK-006, SR-KEY-003, ADR-003, ADR-004 |
...
**해결 매핑:**
| 한계 | ATECC608A 기능 | CryptoAuthLib API |
|---|---|---|
| ADR-004 seed | 하드웨어 TRNG | `atcab_random()` |
| ADR-003 잠금 | monotonic counter / 보안 NV | `atcab_counter()` |
| PSK 저장(SR-KEY-003 강화) | 보안 슬롯 | `atcab_write/read_zone()` |
